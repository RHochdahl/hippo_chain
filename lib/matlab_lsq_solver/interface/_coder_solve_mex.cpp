...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&solve_atexit);
  // Module initialization.
  solve_initialize();
  // Dispatch the entry-point.
  unsafe_solve_mexFunction(nlhs, plhs, nrhs, prhs);
  // Module termination.
  solve_terminate();
}
                                 ...
                                 const mxArray *prhs[2])
{
  ...
  // Call the function.
  solve_api(prhs, &outputs);
  // Copy over outputs to the caller.
  emlrtReturnArrays(1, &plhs[0], &outputs);
}

//
// File trailer for _coder_solve_mex.cpp
//
// [EOF]
//
