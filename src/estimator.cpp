#include <ros/ros.h>
#include <hippo_chain/include/chain_estimator/ChainEstimator.h>
...
{
    EstimatorOptions options = parseArgs(argc, argv);

    ros::init(argc, argv, "chain_estimator");

    ChainEstimator estimator(options.vehicles, options.rate);
